...
export default function RootLayout({ children }) {
    ...
    return (
        ...
        <div className="relative min-h-screen w-screen flex flex-col">
            ...
            flex w-full justify-between items-center py-3 px-4 h-1/10 
            shadow-lg border-b bg-white z-100">
                ...
                <div className="flex items-center gap-x-5 sm:text-xl text-2xl font-semibold">
                    <IoMdMenu onClick={() => { setMenu(!menu) }} className="sm:hidden flex rounded-full hover:bg-gray-300/40 hover:cursor-pointer transition-all duration-300 ease-in-out" />
